...
func TestOSBuildJobExportsCompatibilityUnmarshal(t *testing.T) {
	testCases := []struct {
		...
		{
			jobJSON: []byte(`{"export_stages":["archive"],"targets":[{"name":"org.osbuild.aws","options":{},"osbuild_export":"image"},{"name":"org.osbuild.aws.s3","options":{},"osbuild_export":"archive"}]}`),
			err:     true,
		},
		// Test that different exports defined on the job and target level generate an error
		{
			jobJSON: []byte(`{"export_stages":["image"],"targets":[{"name":"org.osbuild.aws","options":{},"osbuild_export":"archive"},{"name":"org.osbuild.aws.s3","options":{},"osbuild_export":"archive"}]}`),
			err:     true,
		},
...
func TestOSBuildJobExportsCompatibilityMarshal(t *testing.T) {
	testCases := []struct {
		...
		{
			jobJSON: []byte(`{"targets":[{"uuid":"00000000-0000-0000-0000-000000000000","image_name":"","export_filename":"","osbuild_export":"archive","name":"org.osbuild.aws","created":"0001-01-01T00:00:00Z","status":"WAITING","options":{"region":"","accessKeyID":"","secretAccessKey":"","sessionToken":"","bucket":"","key":"","shareWithAccounts":null,"filename":""}}],"export_stages":["archive"]}`),
			job: &OSBuildJob{
				Targets: []*target.Target{
					{
						Name: target.TargetNameAWS,
		...
		{
			jobJSON: []byte(`{"targets":[{"uuid":"00000000-0000-0000-0000-000000000000","image_name":"","export_filename":"","osbuild_export":"archive","name":"org.osbuild.aws","created":"0001-01-01T00:00:00Z","status":"WAITING","options":{"region":"","accessKeyID":"","secretAccessKey":"","sessionToken":"","bucket":"","key":"","shareWithAccounts":null,"filename":""}},{"uuid":"00000000-0000-0000-0000-000000000000","image_name":"","export_filename":"","osbuild_export":"archive","name":"org.osbuild.aws.s3","created":"0001-01-01T00:00:00Z","status":"WAITING","options":{"region":"","accessKeyID":"","secretAccessKey":"","sessionToken":"","bucket":"","key":"","endpoint":"","ca_bundle":"","skip_ssl_verification":false,"filename":""}}],"export_stages":["archive"]}`),
			job: &OSBuildJob{
				Targets: []*target.Target{
					{
						Name: target.TargetNameAWS,
